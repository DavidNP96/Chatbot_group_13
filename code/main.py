...
model_names = ["inform_baseline", "key_word_matching",
               "logistic_regression", "random_forest", "all"]
...
while requested_model_name not in model_names:
    requested_model_name = input(
        "wrong model name! choose one of the following models: 'inform_baseline', 'key_word_matching', 'logistic_regression', 'random_forest' or 'all': ")
